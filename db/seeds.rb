...
20.times do |i|
    ...
    date_time_start = Faker::Time.between_dates(from: Date.today + 1, to: Date.today + 20, period: :afternoon)
    dow_number = rand(1..5)
    ...
    schedule.save!
    date_time_start_app=Faker::Time.between_dates(from: Date.today - 20, to: Date.today, period: :afternoon)
